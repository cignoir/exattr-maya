...
REM Run as a subroutine so cmd parses the block reliably (the prior
REM goto-based form silently skipped the section in some shells).
if %BUILD_COUNT% GTR 0 call :do_carton
